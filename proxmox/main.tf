// main.tf has been split into separate files for clarity:
// - control_plane.tf: K3s control plane VM
// - worker_nodes.tf: K3s worker VM definitions

// Keep provider configuration, variables, and other shared definitions in separate files as needed.
